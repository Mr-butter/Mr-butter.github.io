...
const Projects = () => {
  const projectsData = [
    {
      id: 1,
      projectName: "Superbooster",
      projectDesc: "SNS 플랫폼의 광고/마케팅 대행 상품 판매 쇼핑몰 제작",
      detail: "https://holly-plastic-f70.notion.site/superbooster-1c6bc84668cd80e0a6a1ffa766ccb74b",
      image: "superbooster",
    },
    {
      id: 2,
      projectName: "Artmuse",
      projectDesc: "클레이튼 기반의 NFT를 활용한 진품인증 솔루션",
      detail: "https://holly-plastic-f70.notion.site/artmuse-1c6bc84668cd8069af4efd1439619973",
      image: "artmuse",
    },
